...
struct _JNINativeInterface {
    ...
    /*For Persistence Source  */
    jobject (*SetPersistenceObject)(JNIEnv *env,jobject obj,jstring str);
    jobject (*GetPersistenceObject)(JNIEnv *env,jstring str);
    void (*DeletePersistenceObject)(JNIEnv *env,jstring str);
    /*  Up to here            */
